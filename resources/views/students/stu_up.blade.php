        ...
        <form action="/up_stu" method="post">
            ...
            <table width="100%" border="0" cellpadding="8" cellspacing="0" class="tableBasic">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" name="enterdate" value="{{$data->enterdate}}" size="40" class="inpMain" />
                    </td>
                </tr>
                <tr>
                    <td align="right">退学、毕业日期</td>
                    <td>
                        <input type="text" name="leavedate" value="{{$data->leavedate}}" size="40" class="inpMain" />
                    </td>
                </tr>
                <tr>
                    <td align="right">入住日期</td>
                    <td>
                        <input type="text" name="checkindate" value="{{$data->checkindate}}" size="40" class="inpMain" />
                    </td>
                </tr>
                <tr>
                    <td align="right">退宿日期</td>
                    <td>
                        <input type="text" name="checkoutdate" value="{{$data->checkoutdate}}" size="40" class="inpMain" />
                    </td>
                </tr>
                <tr>
